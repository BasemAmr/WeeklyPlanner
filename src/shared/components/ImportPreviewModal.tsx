...
import { WeekData } from '@/shared/types';
import { Button, Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter, ScrollArea, Collapsible, CollapsibleTrigger, CollapsibleContent, Badge } from '@/design-system/components';
